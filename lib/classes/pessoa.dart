class Pessoa{
 ...
 double getAltura(){
  ...
  double calcularIMC() {
    ...
    return double.parse(imc.toStringAsFixed(2)); // Arredonda o IMC para 2 casas decimais
  }
  ...
  @override
  String toString() {
    return {"Senhor(a)": _nome, "se seu peso é": _peso, 
            "e sua altura é": _altura, 
            "então seu IMC é": calcularIMC() }.toString();
  }
